  ...
  return (
    <div className="flex flex-col gap-8 max-w-3xl">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-5">
          <p className="text-xs text-neutral-500">Botones activos</p>
          <p className="text-3xl font-semibold mt-1">{activeLinks}</p>
        </div>
        <div className="bg-white border border-neutral-200 rounded-2xl p-5">
          <p className="text-xs text-neutral-500">Redes sociales</p>
          <p className="text-3xl font-semibold mt-1">{profile.socialLinks.length}</p>
        </div>
      </div>
